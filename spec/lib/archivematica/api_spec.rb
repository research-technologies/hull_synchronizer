RSpec.describe Archivematica::Api do
  ...
  describe '#start_transfer' do
    ...
    context 'with read timeout' do
      ...
      it 'returns a 598' do
        ...
        expect(start_transfer.request.reason_phrase).to eq('execution expired')
      end
    end
  end
  ...
  describe '#approve_transfer' do
    ...
    context 'with invalid params' do
      ...
      it 'responds with a Faraday::Response containing a warning header' do
        expect(approve_transfer.request.reason_phrase).to eq('directory is required')
      end
    end
  end
  ...
  describe '#transfer_status' do
    ...
    context 'with invalid params' do
      ...
      it 'responds with a Faraday::Response containing a warning header' do
        expect(transfer_status.request.reason_phrase).to eq('uuid is required')
      end
    end
  end
  ...
  describe '#ingest_status' do
    ...
    context 'with invalid params' do
      ...
      it 'responds with a Faraday::Response containing a warning header' do
        expect(ingest_status.request.reason_phrase).to eq('uuid is required')
      end
    end
  end
  ...
  describe '#package_details' do
    ...
    context 'with invalid params' do
      ...
      it 'responds with a Faraday::Response containing a warning header' do
        expect(package_details.request.reason_phrase).to eq('uuid is required')
      end
    end
    ...
    describe '#connection' do
      ...
      it 'responds with a Faraday::Response containing a warning header' do
        expect(start_transfer.request.reason_phrase).to eq('environment variables are not set')
      end
      after do
        ENV['AM_URL'] = 'http://test.host'
      end
