...
RSpec.describe IngestsController, type: :controller do
  ...
  # IngestsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #edit" do
    it "returns a success response" do
      ingest = Ingest.create! valid_attributes
      get :edit, params: { id: ingest.to_param }, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created ingest" do
        post :create, params: { ingest: valid_attributes }, session: valid_session
        expect(response).to redirect_to(Ingest.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the ingest" do
        ingest = Ingest.create! valid_attributes
        put :update, params: { id: ingest.to_param, ingest: valid_attributes }, session: valid_session
  ...
  describe "DELETE #destroy" do
    it "destroys the requested ingest" do
      ingest = Ingest.create! valid_attributes
      expect do
        delete :destroy, params: { id: ingest.to_param }, session: valid_session
      end.to change(Ingest, :count).by(-1)
    end
